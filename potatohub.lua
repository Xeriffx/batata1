...
Section:NewToggle("Super Jump", "JUMPPPPPPPPPPPP", function(state)
    if state then
...
Section:NewButton("Prison Ware", "Other Gui of Prison life", function()
...
Section:NewButton("infinity yeld", "give commands in infinity yeld", function()
...
Section:NewButton("Brookhaven Ice Hub", "Key: NewIceHub", function()
